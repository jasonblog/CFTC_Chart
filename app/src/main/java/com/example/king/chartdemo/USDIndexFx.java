...
public class USDIndexFx extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    Intent intent=new Intent(USDIndexFx.this,MainActivity.class);
                    startActivity(intent);
                }
                else if(id==R.id.action_help)
                {
                    Intent intent=new Intent(USDIndexFx.this,chart_info.class);
                    startActivity(intent);
                }
                else if(id==R.id.action_about)
                {
                    Intent intent=new Intent(USDIndexFx.this,about.class);
                    startActivity(intent);
                }
        ...
        descriptionText="CFTC USD Index";
        ...
        protected LineData doInBackground(String... strings) {
            ...
            try {
                ...
                Request request = new Request.Builder() //設置連線
                        .url("https://www.quandl.com/api/v3/datasets/CFTC/DX_F_L_ALL.json?api_key=Tg54Z7Bexy5stBTrTdTi&start_date=2013-1-1")
                        .build();
