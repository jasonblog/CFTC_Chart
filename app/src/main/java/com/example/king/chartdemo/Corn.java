    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    Intent intent=new Intent(Corn.this,MainActivity.class);
                    startActivity(intent);
                }
                else if(id==R.id.action_help)
                {
                    Intent intent=new Intent(Corn.this,chart_info.class);
                    startActivity(intent);
                }
                else if(id==R.id.action_about)
                {
                    Intent intent=new Intent(Corn.this,about.class);
                    startActivity(intent);
                }
    ...
    private class loadNonReportable extends AsyncTask<String, Void, LineDataSet> {
        ...
        protected LineDataSet doInBackground(String... strings) {
            ...
            try {
                OkHttpClient client = new OkHttpClient();
                Request request = new Request.Builder()
                        .url("https://www.quandl.com/api/v3/datasets/CFTC/C_F_L_ALL.json?api_key=Tg54Z7Bexy5stBTrTdTi&start_date=2013-01-01")
                        .build();
                Response response = client.newCall(request).execute();
                String responseData = response.body().string();
                j = new JSONObject(responseData);
